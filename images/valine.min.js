  ...
  function(e, t, n) {
    ...
    o.prototype.bind = function() {
      ...
      var C = function(t, n, r) {
        var qq_img= T.cdn + (0,
        s.default)(t.get('mail')) + T.params;//默认gravator头像接口
        ...
        var l = t.get('link') ? /^https?\:\/\//.test(t.get('link')) ? t.get('link') : 'http://' + t.get('link') : ''
                ...
                ; var u = T.hide ? '' : e.config.enableQQ && t.get('QQAvatar') ? '<img class="vimg" src="' + qq_img + '" referrerPolicy="no-referrer"/>' : '<img class="vimg" src="' + qq_img + '">'
